# task: 
""" 
In how many lines is one range overlap in the other? 
...
def contains_numbers(first_range, second_range): 
    """It return True if first pair of numbers contain some
    same number like in the second or vice versa. 
    Otherwise return False. """
    for number in first_range: 
        if number in second_range: 
            print(number)
            return True
    else: 
        return False
